...
./gradlew run -Pmain=RecordBook          # the league's record book: the ten highest team weeks ever, the ten highest for one week number across seasons (-Pweek=n), each manager's best week, the ten highest started-player weeks (-Ptop)
